...
<form action="<?php echo e(route('siswa.store')); ?>" method="POST" enctype="multipart/form-data">
    ...
    <input type="text" name="nis" accept="<?php echo e(old('nis')); ?>" required>
    <br><br>
    ...
    <input type="number"  name="hp" value="<?php echo e(old('hp')); ?>"  required>
    <br><br>

    <button type="submit">SIMPAN DATA</button>
    <button type="reset">RESET FORM</button>
</body>
</html><?php /**PATH C:\laragon\www\windi\windi\windi\resources\views/admin/siswa/create.blade.php ENDPATH**/ ?>